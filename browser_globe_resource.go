...
var resourceBrowserGlobeAtlantisSvg = &fyne.StaticResource{
	StaticName:    "browser_globe_atlantis.svg",
	StaticContent: []byte(`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#34A2B5" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><path d="M3 12h18"/><path d="M12 3a14 14 0 0 1 0 18"/><path d="M12 3a14 14 0 0 0 0 18"/></svg>`),
}
...
var resourceBrowserHistoryAtlantisSvg = &fyne.StaticResource{
	StaticName:    "browser_history_atlantis.svg",
	StaticContent: []byte(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#34A2B5" width="24px" height="24px"><path d="M0 0h24v24H0z" fill="none"/><path d="M13 3c-4.97 0-9 4.03-9 9H1l3.89 3.89.07.14L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42C8.27 19.99 10.51 21 13 21c4.97 0 9-4.03 9-9s-4.03-9-9-9zm-1 5v5l4.28 2.54.72-1.21-3.5-2.08V8H12z"/></svg>`),
}
...
func globeResource() fyne.Resource {
	...
	case apptheme.ThemeAtlantis:
		return resourceBrowserGlobeAtlantisSvg
	default:
...
func historyResource() fyne.Resource {
	...
	case apptheme.ThemeAtlantis:
		return resourceBrowserHistoryAtlantisSvg
	default:
