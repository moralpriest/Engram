...
CACHE_PATH="$HOME/go/pkg/mod/fyne.io/fyne/v2@v2.7.3/internal/driver/mobile/app/GoNativeActivity.java"
SOURCE_PATH="$(dirname "$0")/vendor/fyne.io/fyne/v2/internal/driver/mobile/app/GoNativeActivity.java"
